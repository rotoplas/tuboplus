...
export default class SlidesSingleInfoComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      position: null,
  ...
  _getPosition() {
    if (typeof this.props.position === 'number' && this.state.position === null) {
    ...
    return (
      <View style={[
        ...
        <View style={styles.layoutText}>
          <Text style={styles.textCaption}>{ this.props.dataSource[position].title }</Text>
        </View>
        {/* END SECTION TEXT TITLE */}
        ...
        <View style={styles.layoutText}>
          <Text style={styles.textCaption}>{ this.props.dataSource[position].captionLarge }</Text>
        </View>
        {/* END SECTION TEXT DESCRIPTION */}
      </View>
    );
  }
}

SlidesSingleInfoComponent.defaultProps = {
  height: 200,
  indicatorSize: 8,
...
SlidesSingleInfoComponent.propTypes = {
